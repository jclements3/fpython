...
\begin{itemize}
\item \texttt{prelude/prelude.py} -- the toolkit. Study loop: read a section,
close the file, retype its definitions from memory, diff.
\item \texttt{prelude/g1\_\ldots{} g9\_\ldots} -- 74 practice files. Each is
...
\item \texttt{prelude/solutions/} -- the same files solved, flat, named
\texttt{g2\_08\_chunks.py}. For \emph{after} the fight: compare shapes, not
before.
\item \texttt{prelude/prelude\_flowchart.svg} -- the recognition ladder of
