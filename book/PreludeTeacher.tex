...
\noindent\textbf{Solution.}
\begin{lstlisting}[style=code]
account_history = lambda start, txns: scanl(lambda a, b: a + b, start, txns)
\end{lstlisting}
...
\noindent\textbf{Solution.}
\begin{lstlisting}[style=code]
suffix_sums = lambda xs: scanr(lambda a, b: a + b, 0, xs)
\end{lstlisting}
...
\noindent\textbf{Solution.}
\begin{lstlisting}[style=code]
peak_concurrency = lambda events: max(scanl(lambda a, b: a + b, 0, events))
\end{lstlisting}
