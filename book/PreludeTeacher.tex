...
concatenate iterables lazily, one after another.
\begin{lstlisting}[style=ex]
>>> list(chain([1], [2, 3]))
[1, 2, 3]
...
build a linked list from a Python list (a foldr of ListNode).
\begin{lstlisting}[style=ex]
...
walk a linked list back into a Python list; the round-trip partner of from\_list, and the way to make node results printable.
\begin{lstlisting}[style=ex]
