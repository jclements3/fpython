...
\noindent\textbf{Solution.}
\begin{lstlisting}[style=code]
line_totals = lambda prices, quantities: zipWith(lambda p, q: p * q, prices, quantities)
\end{lstlisting}
...
\noindent\textbf{Solution.}
\begin{lstlisting}[style=code]
areas = lambda rects: starmap(lambda w, h: w * h, rects)
\end{lstlisting}
...
\noindent\textbf{Solution.}
\begin{lstlisting}[style=code]
running_product = lambda xs: list(accumulate(xs, lambda a, b: a * b))
\end{lstlisting}
