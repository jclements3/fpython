...
\section{Concepts}
\subsection{\texttt{identity}}\label{def:identity}
...
def compose(*fs):
    ...
    return g
\end{lstlisting}
\subsection{\texttt{o}}\label{def:o}

\begin{lstlisting}[style=ex]
o = compose
\end{lstlisting}
\subsection{\texttt{pipe}}\label{def:pipe}
...
\end{lstlisting}
\subsection{\texttt{FAIL}}\label{def:FAIL}

\begin{lstlisting}[style=ex]
FAIL    = _Sentinel("FAIL")
\end{lstlisting}
\subsection{\texttt{\_MISS}}\label{def:_MISS}
...
mod       = lambda a, b: a % b
\end{lstlisting}
\subsection{\texttt{halve}}\label{def:halve}
...
\end{lstlisting}
\subsection{\texttt{zip\_}}\label{def:zip_}
...
\end{lstlisting}
\subsection{\texttt{map\_}}\label{def:map_}

\begin{lstlisting}[style=ex]
map_      = lambda f, xs: [f(x) for x in xs]
\end{lstlisting}
\subsection{\texttt{filter\_}}\label{def:filter_}
...
def span(cond, xs):
    ...
    return (xs[:i], xs[i:])
\end{lstlisting}
\subsection{\texttt{break\_}}\label{def:break_}
...
\end{lstlisting}
\subsection{\texttt{windows}}\label{def:windows}
...
\end{lstlisting}
\subsection{\texttt{listToMaybe}}\label{def:listToMaybe}

\begin{lstlisting}[style=ex]
listToMaybe = lambda xs: xs[0] if xs else NOTHING
\end{lstlisting}
\subsection{\texttt{maybeToList}}\label{def:maybeToList}
...
\end{lstlisting}
\subsection{\texttt{maybe\_get}}\label{def:maybe_get}
...
\section{Concepts}
\subsection{\texttt{Ok}}\label{def:Ok}

\begin{lstlisting}[style=ex]
Ok  = lambda v: ("ok", v)
\end{lstlisting}
\subsection{\texttt{Err}}\label{def:Err}
...
\end{lstlisting}
\subsection{\texttt{sequenceE}}\label{def:sequenceE}
...
def sequenceE(xs):
    ...
    return Ok(out)
\end{lstlisting}
\subsection{\texttt{traverseE}}\label{def:traverseE}
...
\end{lstlisting}
\subsection{\texttt{partitionEithers}}\label{def:partitionEithers}
\begin{lstlisting}[style=ex]
...
def partitionEithers(xs):
    ...
    return (oks, errs)
\end{lstlisting}
\subsection{\texttt{note}}\label{def:note}
...
\chapter{do-Notation}
\section{Concepts}
\subsection{\texttt{do}}\label{def:do}
...
def do(binder, is_fail):
    ...
    return deco
\end{lstlisting}
\subsection{\texttt{doM}}\label{def:doM}

\begin{lstlisting}[style=ex]
doM = do(bind,  lambda x: x is NOTHING)
\end{lstlisting}
\subsection{\texttt{doE}}\label{def:doE}
...
\section{Concepts}
\subsection{\texttt{doP}}\label{def:doP}
do-notation that THREADS the input: yield a parser, receive its value. Fresh generator per parse -- re-runnable, backtrack-safe under alt.
...
def doP(gen_fn):
    ...
    return make
\end{lstlisting}
\subsection{\texttt{alt}}\label{def:alt}
<|> : first success wins.
...
\end{lstlisting}
\subsection{\texttt{many}}\label{def:many}
...
def many(p):
    ...
    return parser
\end{lstlisting}
\subsection{\texttt{many1}}\label{def:many1}
...
def many1(p):
    ...
    return parser
\end{lstlisting}
\subsection{\texttt{sepBy}}\label{def:sepBy}
...
def sepBy(p, sep):
    ...
    return parser
\end{lstlisting}
\subsection{\texttt{lit}}\label{def:lit}
...
def lit(c):
    ...
    return parser
\end{lstlisting}
\subsection{\texttt{rx}}\label{def:rx}
...
def rx(pat, conv=identity):
    ...
    return parser
\end{lstlisting}
\subsection{\texttt{chainl1}}\label{def:chainl1}
...
def chainl1(p, ops):
    ...
    return parser
\end{lstlisting}
\subsection{\texttt{runParser}}\label{def:runParser}
...
\end{lstlisting}
\subsection{\texttt{Sum}}\label{def:Sum}
...
\end{lstlisting}
\subsection{\texttt{All}}\label{def:All}

\begin{lstlisting}[style=ex]
All     = Monoid(True,  lambda a, b: a and b)
\end{lstlisting}
\subsection{\texttt{Any}}\label{def:Any}

\begin{lstlisting}[style=ex]
Any     = Monoid(False, lambda a, b: a or b)
\end{lstlisting}
\subsection{\texttt{MaxM}}\label{def:MaxM}

\begin{lstlisting}[style=ex]
MaxM    = Monoid(float("-inf"), max)
\end{lstlisting}
\subsection{\texttt{MinM}}\label{def:MinM}

\begin{lstlisting}[style=ex]
MinM    = Monoid(float("inf"),  min)
\end{lstlisting}
\subsection{\texttt{ListM}}\label{def:ListM}

\begin{lstlisting}[style=ex]
ListM   = Monoid([], add)
\end{lstlisting}
\subsection{\texttt{First}}\label{def:First}
